import { Directive, OnDestroy, AfterViewInit, Host, ElementRef, HostListener } from '@angular/core';
import { CompleterItem } from '../model/completer-item';
import { isNil } from '../globals/globals';
import { CompleterDropdown, CtrCompleterDirective } from './ctr-completer.directive';
...
export class CtrDropdownDirective implements CompleterDropdown, OnDestroy, AfterViewInit {

  private rows: CtrRowItem[] = [];
  private currHighlighted: CtrRowItem | undefined;
  private isScrollOn: boolean;
  private _rowMouseDown = false;

  constructor( @Host() private completer: CtrCompleterDirective, private el: ElementRef) {
