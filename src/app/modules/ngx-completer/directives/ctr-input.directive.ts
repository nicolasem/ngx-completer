...
import { Directive, HostListener, Input, Output, EventEmitter, Host, ElementRef } from '@angular/core';
...
export class CtrInputDirective {
  ...
  constructor( @Host() private completer: CtrCompleterDirective, private ngModel: NgModel, private el: ElementRef) {
